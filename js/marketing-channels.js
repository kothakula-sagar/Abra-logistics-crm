...
function closeCampaign(ch){state[ch].activeCampaignId=null;state[ch].search='';renderChannel(ch)}
...
if(ch==='email'&&campaign.emailProvider==='Outlook')window.location.href=url;else window.open(url,'_blank','noopener,noreferrer');
